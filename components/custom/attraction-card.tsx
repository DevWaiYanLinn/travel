        ...
        >
            ...
            <View className="flex-1">
                <View className="flex-1 justify-between">
                    <Text className="text-lg font-bold text-gray-600">{props.name}</Text>
                    <Text className="text-gray-500 font-bold text-xs">
                        {t('Ticket Price')}: <Text className="text-indigo-400">{props.ticketPrice}</Text>
                    </Text>
                    <Text className="text-gray-500 font-bold text-xs">
                        {t('Hours')}: <Text className="text-indigo-400">{props.hours}</Text>
                    </Text>
                    <Text className="text-gray-500 font-bold text-xs">
                        {t('Location')}: <Text className="text-indigo-400">{props.location}</Text>
                    </Text>
                </View>
                <Pressable onPress={props.onCommentPress} className="mt-2">
                    <View className="flex-row w-full rounded-lg justify-end items-center gap-5">
                        ...
                        <View className="flex-row gap-1 items-center">
                            <FontAwesome name="comment-o" size={15} color="#818cf8" />
