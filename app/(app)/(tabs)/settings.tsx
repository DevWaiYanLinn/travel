...
export default function Tab() {
    ...
    return (
        <View style={styles.container}>
            ...
            >
                <BottomSheetView style={styles.contentContainer} className="p-3 bg-white">
                    <View className="flex-1 w-full">
                        <View className="flex-col items-center justify-center sticky top-0">
                            <Image
                                ...
                                resizeMode="cover"
                            />
                            <Text className="text-3xl text-gray-600 text-center mt-3 font-bold">{t('Meow Map')}</Text>
                        </View>
