...
export default function Attraction() {
    ...
    const handleCommentModalChange = useCallback((index: number) => { }, [])
            ...
            <ScrollView showsVerticalScrollIndicator={false} className='flex-1 mt-5'>
                <View className='flex-row p-3 flex gap-5  bg-white rounded-lg'>
                    <View className='relative'>
                        <Image className='rounded-md' resizeMode='cover' style={{ width: Dimensions.get('window').width * 0.35, height: Dimensions.get('window').width * 0.35 }} source={require('@/assets/city/sky-tree.jpg')} />
                    ...
                    <View className='flex-1'>
                        <View className='flex-1 justify-between'>
                            ...
                            <Text className='text-gray-500' style={{ fontSize: 12 }}>
                                {t('Ticket Price')} :
                                <Text className='text-blue-400' style={{ fontSize: 12 }}> {t('Free')}</Text>
                            </Text>
                            <Text className='text-gray-500' style={{ fontSize: 12 }}>
                                {t('Hours')} :
                                <Text className='text-blue-400' style={{ fontSize: 12 }}> 9:00AM - 10:00PM</Text>
                            </Text>
                            <Text className='text-gray-500' style={{ fontSize: 12 }}>
                                {t('Location')} :
                                <Text className='text-blue-400' style={{ fontSize: 12 }}> {t('Click')}</Text>
                            </Text>
                        </View>
                        <Pressable onPress={handleCommentModalPress}>
                            <View className='flex-row w-full rounded-lg justify-end items-center gap-5'>
                                <View className='flex-row gap-1 items-center'>
                                    ...
                                    <Text style={{ fontSize: 10 }} className=' text-gray-500'>99k</Text>
                                </View>
                                <View className='flex-row gap-1 items-center'>
                                    <FontAwesome name="comment-o" size={15} color="#6b7280" />
                                    <Text style={{ fontSize: 10 }} className='text-sm text-gray-500'>100</Text>
                                </View>
                            </View>
                        </Pressable>
                    </View>
                ...
                <View className='flex-row p-3 flex gap-5  bg-white rounded-lg mt-5'>
                    <View className='relative'>
                        <Image className='rounded-md' resizeMode='cover' style={{ width: Dimensions.get('window').width * 0.35, height: Dimensions.get('window').width * 0.35 }} source={require('@/assets/city/osaka-castle.jpg')} />
                        <View className="absolute top-2 right-2 bg-gray-100  rounded-full p-1">
                    ...
                    <View className='flex-1'>
                        <View className='flex-1 justify-between'>
                            ...
                            <Text className='text-gray-500' style={{ fontSize: 12 }}>
                                {t('Ticket Price')} :
                                <Text className='text-blue-400' style={{ fontSize: 12 }}> {t('1000¥')}</Text>
                            </Text>
                            <Text className='text-gray-500' style={{ fontSize: 12 }}>
                                {t('Hours')} :
                                <Text className='text-blue-400' style={{ fontSize: 12 }}> 9:00AM : 10:00PM</Text>
                ...
                <View className='flex-row p-3 flex gap-5  bg-white rounded-lg mt-5'>
                    <View className='relative'>
                        <Image className='rounded-md' resizeMode='cover' style={{ width: Dimensions.get('window').width * 0.35, height: Dimensions.get('window').width * 0.35 }} source={require('@/assets/city/megane-bridge.png')} />
                        <View className="absolute top-2 right-2 bg-gray-100  rounded-full p-1">
                            <AntDesign name="hearto" size={16} color="red" />
                        </View>
                    </View>
                    <View className='flex-1'>
                        <View className='flex-1 justify-between'>
                            ...
                            <Text className='text-gray-500' style={{ fontSize: 12 }}>
                                {t('Hours')} :
                                <Text className='text-blue-400' style={{ fontSize: 12 }}> 24 Hours</Text>
                            </Text>
                            <Text className='text-gray-500' style={{ fontSize: 12 }}>
                                {t('Location')} :
                                <Text className='text-blue-400' style={{ fontSize: 12 }}> {t('Click')}</Text>
                        ...
                        <View className='flex-row w-full rounded-lg justify-end mb-2 items-center gap-5'>
                            ...
                            <View className='flex-row gap-1 items-center'>
                                <FontAwesome name="comment-o" size={15} color="#6b7280" />
                                <Text style={{ fontSize: 10 }} className='text-sm text-gray-500'>50</Text>
                            </View>
                        </View>
                    </View>
                ...
                <View className='flex-row p-3 flex gap-5  bg-white rounded-lg mt-5'>
                    <View className='relative'>
                        <Image className='rounded-md' resizeMode='cover' style={{ width: Dimensions.get('window').width * 0.35, height: Dimensions.get('window').width * 0.35 }} source={require('@/assets/city/glover-garden.png')} />
                        <View className="absolute top-2 right-2 bg-gray-100  rounded-full p-1">
                            <AntDesign name="hearto" size={16} color="red" />
                        </View>
                    </View>
                    <View className='flex-1'>
                        <View className='flex-1 justify-between'>
                            ...
                            <Text className='text-gray-500' style={{ fontSize: 12 }}>
                                {t('Hours')} :
                                <Text className='text-blue-400' style={{ fontSize: 12 }}> 9:00AM</Text>
                            </Text>
                            <Text className='text-gray-500' style={{ fontSize: 12 }}>
                                {t('Location')} :
                                <Text className='text-blue-400' style={{ fontSize: 12 }}> {t('Click')}</Text>
