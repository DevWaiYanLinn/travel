                ...
                <View className="flex-1 mt-5 gap-5">
                    <View className="flex-1">
                        ...
                        <View className="flex-1 flex-row gap-5 mt-5">
                            <View className="flex-1 relative rounded-lg bg-white pt-3 px-3 overflow-hidden">
                                <Image
                            ...
                            <View className="flex-1 rounded-lg px-3 pt-3 relative bg-white overflow-hidden">
                                <Image
                                    className="w-full h-[75%] rounded-md"
                                    resizeMode="cover"
                    ...
                    <View className="flex-1">
                        ...
                        <View className="flex-1 flex-row gap-5 mt-5">
                            <View className="flex-1 rounded-lg bg-white px-3 pt-3 overflow-hidden relative">
                                <Image
                                    className="w-full h-[75%] rounded-md"
                                    resizeMode="cover"
                            ...
                            <View className="flex-1 rounded-lg px-3 pt-3 bg-white overflow-hidden relative">
                                <Image
                                    className="w-full h-[75%] rounded-md"
                                    resizeMode="cover"
